...
// Цвета для узлов
const nodeColors = {
    user: 0x1dd1a1, // Мятный зеленый для пользователей
    group: 0xfeca57 // Оранжевый для групп
};
...
// Получение узлов пользователей и групп
...
// Отображение информации о выбранном узле
...
async function displayNodeInfo(node) {
    ...
    relationships.forEach(rel => {
        ...
        if (targetNode) {
            ...
            const material = new THREE.LineBasicMaterial({ color: 0x4287f5 }); // Синий цвет связей
